...
$query = "SELECT * FROM beverages WHERE id = ?";
...
<head>
    <meta charset="UTF-8">
    <title><?= htmlspecialchars($beverage['name']) ?> - Foodie Vibe</title>
      <style>
body {
...
<body>
    <div class="container">
    <h1><?= htmlspecialchars($beverage['name']) ?></h1>
    ...
    <div class="details-container">
        <div class="section ingredients-section">
            <h3>Ingredients</h3>
            <p><?= nl2br(htmlspecialchars($beverage['ingredients'])) ?></p>
        </div>
        <div class="section instructions-section">
            <h3>Instructions</h3>
            <p><?= nl2br(htmlspecialchars($beverage['instructions'])) ?></p>
        </div>
    </div>
    <a href="beverages.php" class="btn-back">← Back to Beverages</a>
</body>
