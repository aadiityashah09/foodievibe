...
$snack_id = isset($_GET['id']) ? intval($_GET['id']) : 0;
...
<head>
<meta charset="UTF-8" />
<title><?= htmlspecialchars($snack['name']) ?> - Foodie Vibe</title>
<style>
body {
...
<body>
<div class="container">
    <h1><?= htmlspecialchars($snack['name']) ?></h1>
    ...
    <div class="details-container">
        <div class="section ingredients-section">
            <h3>Ingredients</h3>
            <p><?= nl2br(htmlspecialchars($snack['ingredients'])) ?></p>
        </div>
        <div class="section instructions-section">
            <h3>Instructions</h3>
            <p><?= nl2br(htmlspecialchars($snack['instructions'])) ?></p>
        </div>
    </div>
    <a href="snacks.php" class="btn-back">← Back to Snacks</a>
</div>
</body>
</html>
<?php
