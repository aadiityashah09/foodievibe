...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["add_product"])) {
    ...
    if (isset($_FILES['product_image'])) {
        ...
        if (move_uploaded_file($image_tmp, $upload_path)) {
            $sql = "INSERT INTO snacks (name, ingredients, instructions, image) 
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["delete_product"])) {
    $id = $_POST["product_id"];
    $result = $conn->query("SELECT image FROM snacks WHERE id = $id");
...
<head>
    <meta charset="UTF-8">
    <title>Admin Panel - Snacks</title>
    <style>
        body {
...
<body>
    <header>
        <h1>Admin Panel - Snacks</h1>
    </header>

    <section class="admin-section">
        <h2>Add New Snack</h2>
        <form method="POST" enctype="multipart/form-data" class="admin-form">
            <input type="text" name="product_name" placeholder="Snack Name" required>
            ...
            <button type="submit" name="add_product">Add Snack</button>
        </form>
        ...
        <table>
            ...
            <tbody>
                ...
                <?php else: ?>
                    <tr>
                        <td colspan="6">No snacks found.</td>
                    </tr>
                <?php endif; ?>
            </tbody>
        </table>
    ...
    <div id="updateModal" class="modal">
        ...
        <form method="POST" class="admin-form">
            ...
            <input type="text" name="update_product_name" id="update_product_name" placeholder="Snack Name" required>
            ...
            <textarea name="update_product_instructions" id="update_product_instructions" placeholder="Instructions"
                required></textarea>
            <button type="submit" name="update_product">Update Snack</button>
